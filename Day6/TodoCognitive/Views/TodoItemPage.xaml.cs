...
namespace TodoCognitive
{
    public partial class TodoItemPage : ContentPage
    {
        ...
        public TodoItemPage()
        {
            ...
            bingSpeechService = new BingSpeechService(new AuthenticationService(Constants.BingSpeechApiKey, Constants.SpeechAuthenticationTokenEndpoint), Device.RuntimePlatform);
            bingSpellCheckService = new BingSpellCheckService();
            textTranslationService = new TextTranslationService(new AuthenticationService(Constants.TextTranslatorApiKey, Constants.AuthenticationTokenEndpoint));
        }
